...
type SysUser struct {
	...
	WxSessionKey  string `gorm:"column:wx_session_key;type:varchar(100);not null;default:''" json:"wx_session_key" comment:"微信会话密钥"`
	WxUnionid     string `gorm:"column:wx_unionid;type:varchar(100);not null;default:''" json:"wx_unionid" comment:"微信UnionID"`
